...
TEST(Asm, cmp_reg_imm1) {
    std::vector<std::vector<std::uint8_t>> codes = {
        {0x40,0x80,0xff,0x12},
        {0x66,0x81,0xff,0x12,0x00},
        {0x81,0xff,0x12,0x00,0x00,0x00},
        {0x48,0x81,0xff,0x12,0x00,0x00,0x00}
    };
    std::vector<std::string> names = {
        "cmpb $18, %dil",
        "cmpw $18, %di",
...
TEST(Asm, cmp_mem_imm1) {
    const std::vector<std::vector<std::uint8_t>> codes = {
        {0x80,0x7e,0x17,0x12},
        {0x66,0x81,0x7e,0x17,0x12,0x00},
        {0x81,0x7e,0x17,0x12,0x00,0x00,0x00},
        {0x48,0x81,0x7e,0x17,0x12,0x00,0x00,0x00}
    };
...
TEST(Asm, movzx_reg_reg1_to_qword) {
    std::vector<std::vector<std::uint8_t>> codes = {
        {0x48,0x0f,0xb6,0xd0},
        {0x48,0x0f,0xb7,0xd0},
    };
    ...
    const auto generator = [](const std::uint8_t size) {
        aasm::AsmEmitter a;
        a.movzx(size,8, aasm::rax, aasm::rdx);
        return a;
    };
...
TEST(Asm, movzx_reg_reg2_to_dword) {
    const std::vector<std::vector<std::uint8_t>> codes = {
        {0x0f,0xb6,0xf8},
        {0x0f,0xb7,0xf8},
    };
    ...
    const auto generator = [](const std::uint8_t size) {
        aasm::AsmEmitter a;
        a.movzx(size,4, aasm::rax, aasm::rdi);
        return a;
    };
...
TEST(Asm, movzx_reg_reg1_to_word) {
    ...
    const auto generator = [](const std::uint8_t size) {
        aasm::AsmEmitter a;
        a.movzx(size, 2, aasm::rax, aasm::rdx);
        return a;
    };
...
TEST(Asm, movsx_reg_reg1_to_qword) {
    const std::vector<std::vector<std::uint8_t>> codes = {
        {0x48,0x0f,0xbe,0xd0},
        {0x48,0x0f,0xbf,0xd0},
    };
    ...
    const auto generator = [](const std::uint8_t size) {
        aasm::AsmEmitter a;
        a.movsx(size,8, aasm::rax, aasm::rdx);
        return a;
    };
...
TEST(Asm, movsx_addr_reg1_to_word) {
    const std::vector<std::vector<std::uint8_t>> codes = {
        {0x66,0x0f,0xbe,0x32},
    };
    const std::vector<std::string> names = {
