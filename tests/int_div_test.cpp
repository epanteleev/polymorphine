...
static Module reminder(const SignedIntegerType* ty) {
    ModuleBuilder builder;
    {
...
static Module idiv_quotient_reminder_i64(const SignedIntegerType* ty) {
    ModuleBuilder builder;
    {
...
static Module idiv_reminder_quotient_i64(const SignedIntegerType* ty) {
    ModuleBuilder builder;
    {
        const auto tuple_ty = TupleType::tuple(ty, ty);
