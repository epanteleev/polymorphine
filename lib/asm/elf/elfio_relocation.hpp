...
namespace elf {
    ...
    template<class S>
    class relocation_section_accessor_template final {
    public:
        //------------------------------------------------------------------------------
        //! \brief Constructor
        ...
        bool get_entry(Elf_Xword index,
            ...
            if (SHT_RELA == relocation_section->get_type()) {
    ...
    private:
        ...
        bool generic_get_entry_rel(Elf_Xword index,
            ...
            offset = pEntry->r_offset;
            Elf_Xword tmp = pEntry->r_info;
        ...
        void generic_set_entry_rel(Elf_Xword index,
            ...
            pEntry->r_offset = pEntry->r_offset;
            pEntry->r_info = pEntry->r_info;
        }
        ...
        void generic_set_entry_rela(Elf_Xword index,
            ...
            pEntry->r_offset = pEntry->r_offset;
            pEntry->r_info = pEntry->r_info;
            pEntry->r_addend = pEntry->r_addend;
        }
