...
namespace aasm {
    std::string_view GPReg::name(std::size_t size) const noexcept {
        static std::string_view reg_names8[] = {
            "rax", "rcx", "rdx", "rbx", "rsp", "rbp", "rsi", "rdi",
            "r8",  "r9",  "r10", "r11", "r12", "r13", "r14", "r15"
        };

        static std::string_view reg_names4[] = {
            "eax", "ecx", "edx", "ebx", "esp", "ebp", "esi", "edi",
            "r8d",  "r9d",  "r10d", "r11d", "r12d", "r13d", "r14d", "r15d"
        };

        static std::string_view reg_names2[] = {
            "ax", "cx", "dx", "bx", "sp", "bp", "si", "di",
            "r8w",  "r9w",  "r10w", "r11w", "r12w", "r13w", "r14w", "r15w"
        };

        static std::string_view reg_names1[] = {
            "al", "cl", "dl", "bl", "spi", "bpl", "sil", "dil",
