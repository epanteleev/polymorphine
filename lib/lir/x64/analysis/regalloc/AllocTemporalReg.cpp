...
namespace details {
    GPOp AllocTemporalReg::convert_to_gp_op(const LIROperand &val) const {
    ...
    void AllocTemporalReg::cmov_i(aasm::CondType cond_type, const LIRVal &out, const LIROperand &in1, const LIROperand &in2) {
