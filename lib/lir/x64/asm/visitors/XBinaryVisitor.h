...
class XBinaryVisitor {
public:
    virtual ~XBinaryVisitor() = default;

    virtual void emit(aasm::XmmReg out, aasm::XmmReg in1, aasm::XmmReg in2) = 0;
    virtual void emit(aasm::XmmReg out, aasm::XmmReg in1, const aasm::Address& in2) = 0;
    virtual void emit(aasm::XmmReg out, const aasm::Address& in1, aasm::XmmReg in2) = 0;
    virtual void emit(aasm::XmmReg out, const aasm::Address& in1, const aasm::Address& in2) = 0;

    virtual void emit(aasm::XmmReg out, aasm::XmmReg in1, std::int64_t in2) = 0;
    virtual void emit(aasm::XmmReg out, std::int64_t in1, aasm::XmmReg in2) = 0;
    ...
    virtual void emit(const aasm::Address& out, aasm::XmmReg in1, aasm::XmmReg in2) = 0;
    virtual void emit(const aasm::Address& out, aasm::XmmReg in1, const aasm::Address& in2) = 0;
    ...
    virtual void emit(const aasm::Address& out, aasm::XmmReg in1, std::int64_t in2) = 0;
    ...
    template<std::derived_from<XBinaryVisitor> Vis>
    static void dispatch(Vis &visitor, const XVReg &out, const XOp &in1, const XOp &in2) {
