...
public:
    ...
    std::pair<const FunctionPrototype*, bool> insert(const Type* ret_type, std::vector<const NonTrivialType*>&& arg_types, std::string&& name, std::vector<AttributeSet>&& attributes, const FunctionLinkage linkage) {
        auto key = name;
